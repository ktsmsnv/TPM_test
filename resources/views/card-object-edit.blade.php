                                ...
                                <div class="objectDocs">
                                    <ul>
                                        <li class="d-flex align-items-center gap-3 mb-4">
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Удалить файл"><i class="bi bi-trash3"></i></button>
                        ...
                        <div class="member_card_style image">
                            <div class="member-info">
                                <div class="d-flex justify-content-between mb-4">
                                    ...
                                    <button class="btn btn-secondary d-none" data-bs-toggle="modal" data-bs-target="#imageDownloadModal">Заменить</button>
                                    <button class="btn btn-danger d-none" data-bs-toggle="modal" data-bs-target="#imageDownloadModal">Удалить</button>
                                </div>
