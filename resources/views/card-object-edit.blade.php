...
@section('content')
    <div class="container custom_tab_style1_outer">
        <div class="row">
            ...
            <h1 class="mb-4"><strong>Редактирование карточки объекта</strong></h1>
        </div>
                                ...
                                <ul>
                                    <li class="d-flex align-items-center gap-3 mb-4">
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip"
                                                title="Удалить файл"><i class="bi bi-trash3"></i></button>
                                        <a href="" data-toggle="tooltip" title="нажмите чтобы скачать">Акт входного
                                            контроля Сварочный аппарат полуавтомат.pdf</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="member_card_style image">
                        <div class="member-info">
                            <div class="d-flex justify-content-between mb-4">
                                ...
                                <button class="btn btn-secondary d-none" data-bs-toggle="modal"
                                        data-bs-target="#imageDownloadModal">Заменить
                                </button>
                                <button class="btn btn-danger d-none" data-bs-toggle="modal"
                                        data-bs-target="#imageDownloadModal">Удалить
                                </button>
                            </div>
                ...
                <div id="service__blocks" class="d-grid">
                            ...
                            <div class="member-info--inputs d-flex gap-5">
                                ...
                                <div class="d-flex flex-column gap-3 w-50">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        ...
                                        <div class="color-options" data-toggle="tooltip"
                                             title="нажмите на выбранный цвет">
                    ...
                    <div class="member_card_style types">
                        <div class="member-info">
                            <div class="d-flex justify-content-between mb-4">
                                <h4>Виды работ</h4>
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#typesModal">
                                    Добавить вид работ
                                </button>
                            </div>
                                    ...
                                    <div class="grid-item">
                                        <div class="form-check d-flex align-items-center gap-2">
                                            <input class="form-check-input" type="checkbox" value=" " id=" "
                                                   data-toggle="tooltip" title="нажмите чтобы выбрать">
