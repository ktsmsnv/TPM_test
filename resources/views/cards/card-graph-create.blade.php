                                    ...
                                    <div class="member-info--inputs d-flex gap-5">
                                        <div class="d-flex flex-column gap-3 w-50">
                                            <div class="d-flex justify-content-between align-items-center gap-3">
                                                ...
                                                <input name="name" value="{{ $nameGraph }}" class="form-control w-100"
                                                       readonly>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center gap-3">
                                                ...
                                                <input name="infrastructure"
                                                       value="{{ $selectedObjectMain->first()->infrastructure }}"
                                                       class="form-control w-100" readonly>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center gap-3">
                                                <label class="w-100">Куратор</label>
                                                <input name="curator" class="form-control w-100" value="{{ $selectedObjectMain->first()->curator }}" readonly
                                        ...
                                        <div class="d-flex flex-column gap-3 w-50">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center gap-3">
                                                ...
                                                <input type="" class="form-control w-100" name="date_last_save"
                                                       data-toggle="tooltip"
                                                       title="Дата последнего сохранения появляется и меняется автоматически, после сохранения"
                                                       placeholder="Дата последнего сохранения" readonly
                                                       style="opacity: 0.5;">
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center gap-3">
                                                <label class="w-100">Дата архивации</label>
                                                <input type="" class="form-control w-100" name="date_archive"
                                                       data-toggle="tooltip"
