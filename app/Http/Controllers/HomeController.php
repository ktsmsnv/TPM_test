    ...
    public function getObjects() {
        ...
        foreach ($objects as $object) {
            ...
            $formattedObject = [
                ...
                'infrastructure' => $object['infrastructure'] ?? null,
                'name' => $object['name'] ?? null,
                'curator' => $object['curator'] ?? null,
                'number' => $object['number'] ?? null,
                'location' => $object['location'] ?? null,
                'date_usage' => $object['date_usage'] ?? null,
                'date_usage_end' => $object['date_usage_end'] ?? null,
                'date_cert_end' => $object['date_cert_end'] ?? null,
